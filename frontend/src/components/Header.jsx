...
// --- GLOBAL SEARCH COMPONENT MOVED OUTSIDE TO PREVENT FOCUS LOSS ---
const GlobalSearch = ({ 
            ...
            <style>
                {`
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    ...
                    .dropdown-item { 
                        display: block; padding: 12px 20px; text-decoration: none; color: #333; font-size: 14px; font-weight: 500; border-bottom: 1px solid #f0f0f0; width: 100%; text-align: left; background: none; border: none; cursor: pointer; transition: all 0.2s ease;
                    }
                    .dropdown-item:hover { 
                        background-color: ${burgundyColor}; color: ${goldColor} !important; padding-left: 24px;
                    }
                    ...
                    .suggestion-list { 
                        position: absolute; top: calc(100% + 2px); left: 0; width: 100%; background: white; box-shadow: 0 4px 16px 0 rgba(0,0,0,.2); z-index: 6000; max-height: 500px; overflow-y: auto; border-radius: 0 0 2px 2px; user-select: none;
                    }
                ...
                {isMobile ? (
                    <>
                        <div style={{ display: "flex", width: "100%", justifyContent: "space-between", alignItems: "center", marginBottom: "15px" }}>
                            <Link to="/" onClick={closeAllMenus} style={{ textDecoration: "none" }}>
                                <h1 style={{ color: goldColor, margin: 0, fontSize: "22px", fontFamily: "'Playfair Display', serif", fontStyle: "italic" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
                        <Link to="/" onClick={closeAllMenus} style={{ textDecoration: "none", flexShrink: 0 }}>
                            <h1 style={{ color: goldColor, margin: 0, fontSize: "28px", fontFamily: "'Playfair Display', serif", fontStyle: "italic", whiteSpace: "nowrap" }}>
                                Gopi Nath Collection
                            </h1>
                        </Link>
                        <GlobalSearch 
